...
namespace Data
{
    public class ItemRepository : IGetItemRepository
    {
        public IList<Item> GetAllItems()
        {
            ...
            {
                new SaleableItem { Name = "+5 Dexterity Vest", SellIn = 10, Quality = 20 },
                new AgedBrie { Name = "Aged Brie", SellIn = 2, Quality = 0 },
                new SaleableItem { Name = "Elixir of the Mongoose", SellIn = 5, Quality = 7 },
                ...
                new SaleableItem { Name = "Conjured Mana Cake", SellIn = 3, Quality = 6 }
            };
